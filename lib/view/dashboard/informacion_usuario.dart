...
class InformacionUsuarioPage extends StatelessWidget {
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: const Color(0xFFFDB462).withOpacity(0.2), // Mustard yellow with opacity
                borderRadius: BorderRadius.circular(20),
                border: Border.all(color: const Color(0xFFFDB462), width: 1.5),
              ),
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  Icon(Icons.badge, color: const Color(0xFFFDB462), size: 14),
            ...
            Container(
              padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
              decoration: BoxDecoration(
                color: const Color(0xFFA6CE39).withOpacity(0.2), // Green with opacity
                borderRadius: BorderRadius.circular(20),
              ...
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  Icon(Icons.check_circle, color: const Color(0xFFA6CE39), size: 14),
                  const SizedBox(width: 4),
                  Text(
                    "Activo",
                    style: TextStyle(
  ...
  /// Formatea una fecha con hora usando el formato estándar "dd-MM-yyyy hh:mm a"

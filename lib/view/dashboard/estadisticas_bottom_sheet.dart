...
class _EstadisticasBottomSheetState extends State<EstadisticasBottomSheet>
        ...
        child: Column(
          ...
          children: [
            ...
            _buildMisCodigosSection(
              textColor: textColor,
              isDark: isDark,
              scrollController: _scrollControllerQr,
            ),
          ],
        ),
      ),
  ...
  /// Listado de transacciones débito QR del día (mismo servicio que Códigos QR > Mis códigos).
  ...
  Widget _buildTransaccionItem({
    ...
    if (isRecarga) {
      ...
      // Débito: esQR == 0 → tarjeta física, sino → código QR (igual que en Registros del dashboard)

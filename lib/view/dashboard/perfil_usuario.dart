...
class PerfilUsuarioPage extends StatelessWidget {
                  ...
                  child: SingleChildScrollView(
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          // Profile picture
                          _buildProfilePicture(isDark: isDark),
  ...
  Widget _buildProfilePicture({bool isDark = true}) {
      ...
      children: [
        ...
        Positioned(
          ...
          child: GestureDetector(
            onTap: () {
              // Aquí puedes agregar la lógica para seleccionar/actualizar la imagen
              // Por ejemplo: _pickImage() o mostrar un diálogo
            },
            child: Container(
              width: 36,
              height: 36,
